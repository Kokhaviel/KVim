...
public class PathMatcher extends AbstractMatcher {
	...
	private static IMatcher createNameMatcher0(String segment,
											   Character pathSeparator, boolean dirOnly, boolean lastSegment) throws InvalidPatternException {
		if(WildMatcher.WILDMATCH.equals(segment) || WildMatcher.WILDMATCH2.equals(segment))
	...
	public boolean matches(String path, boolean assumeDirectory,
		...
		return iterate(path, path.length(), assumeDirectory, pathMatch);
	}
